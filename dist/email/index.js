...
exports.otpSendEmailSignInVerification = otpSendEmailSignInVerification;
exports.otpSendEmail = otpSendEmail;
exports.sendApplicationEmail = sendApplicationEmail;
const axios_1 = __importDefault(require("axios"));
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
async function otpSendEmailSignInVerification(emailTo, name, otpCode) {
    const apiKey = process.env.BREVO_API_KEY;
    const response = await axios_1.default.post("https://api.sendinblue.com/v3/smtp/email", {
        sender: {
...
async function otpSendEmail(emailTo, name, otpCode) {
    const apiKey = process.env.BREVO_API_KEY;
    const response = await axios_1.default.post("https://api.sendinblue.com/v3/smtp/email", {
        sender: {
            email: process.env.EMAIL_FROM,
...
async function sendApplicationEmail(emailTo, name, tenantName, occupation, income, idnumber, iddocs) {
    const apiKey = process.env.BREVO_API_KEY;
    const response = await axios_1.default.post("https://api.sendinblue.com/v3/smtp/email", {
        sender: {
            email: process.env.EMAIL_FROM,
